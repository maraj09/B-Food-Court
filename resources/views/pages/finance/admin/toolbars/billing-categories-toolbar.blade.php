<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
  ...
  <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
    ...
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
      <!--begin::Title-->
      <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Billing
        Categories</h1>
      <!--end::Title-->
      <!--begin::Breadcrumb-->
      <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-muted">Billing Categories</li>
        <!--end::Item-->
      </ul>
      <!--end::Breadcrumb-->
    </div>
    ...
    <div class="d-flex align-items-center gap-2 gap-lg-3">
      ...
      <div class="d-flex align-items-center gap-2 gap-lg-3">
        ...
        <a href="#" id="kt_drawer_billing_category_button" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal"
          >
          Add Category
        </a>
        <!--end::Primary button-->
