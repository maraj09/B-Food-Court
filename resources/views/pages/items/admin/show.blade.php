...
@section('contents')
  <form action="/dashboard/items/{{ $item->id }}/delete" method="post" id="item_delete_form">
    @csrf
    @method('delete')
  </form>
  <!--begin::Toolbar-->
  @include('pages.items.admin.toolbar.showToolbar')
  <!--end::Toolbar-->
  <!--begin::Content-->
  <div id="kt_app_content" class="app-content flex-column-fluid mt-20 mt-lg-0">
    ...
    <div id="kt_app_content_container" class="app-container container-xxl ">
      <!--begin::Form-->
      <form id="kt_edit_item_form" action="/dashboard/items/{{ $item->id }}" enctype="multipart/form-data" method="POST"
        ...
        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
          ...
          <div class="card card-flush py-4">
            ...
            <div class="card-body pt-0">
              ...
              <!--begin::Input-->
              <select class="form-select" name="vendor_id" data-control="select2" data-placeholder="Select an option">
                <option></option>
                @foreach ($vendors as $vendor)
                  <option value="{{ $vendor->id }}" {{ $item->vendor_id === $vendor->id ? 'selected' : '' }}>
              ...
              <!--begin::Description-->
              <div class="text-muted fs-7 mb-7">Add vendor to a product.</div>
              <!--end::Description-->
              <!--end::Input group-->
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
          ...
          <div class="tab-content">
            ...
            <!--begin::Tab pane-->
            @include('pages.items.admin.components.show.reviews')
            <!--end::Tab pane-->
          </div>
          <!--end::Tab content-->
          ...
          <div class="d-flex justify-content-end">
            <!--begin::Button-->
            <a href="/dashboard/items" id="kt_ecommerce_add_product_cancel" class="btn btn-light me-5">
              Back
            </a>
            <!--end::Button-->
