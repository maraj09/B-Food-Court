<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
  ...
  <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
    ...
    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
      <!--begin::Title-->
      <h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">Vendors</h1>
      <!--end::Title-->
      <!--begin::Breadcrumb-->
    ...
    <div class="d-flex align-items-center gap-2 gap-lg-3">
      ...
      <div class="d-flex align-items-center gap-2 gap-lg-3">
        ...
        <button id="kt_add_vendor_toggle" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="tooltip"
          data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover" data-bs-original-title="Add Vendor"
          data-kt-initialized="1">
          <span id="kt_engage_demos_label">Add Vendor</span>
        </button>
        <!--end::Primary button-->
      </div>
      <!--end::Actions-->
