    ...
    <div id="kt_app_content_container" class="app-container container-xxl">
      ...
      <div class="card">
        ...
        <form id="kt_project_settings_form" class="form fv-plugins-bootstrap5 fv-plugins-framework" method="POST"
          action="/dashboard/coupons/store" novalidate="novalidate">
          @csrf
          <!--begin::Card body-->
            ...
            <div class="row mb-8">
              ...
              <div class="col-xl-3 fv-row fv-plugins-icon-container">
                <input type="text" class="form-control form-control-solid @error('code') is-invalid @enderror"
                  name="code" placeholder="Enter Coupon Code" value="{{ old('code') }}">
              ...
              <div class="col-xl-3 fv-row fv-plugins-icon-container">
                <input type="number" class="form-control form-control-solid @error('discount') is-invalid @enderror"
                  name="discount" placeholder="Discount Rate" value="{{ old('discount') }}">
                <div class="fv-plugins-message-container invalid-feedback">
                  @error('discount')
                    {{ $message }}
                  @enderror
              ...
              <!--begin::Col-->
              <div class="col-xl-3 fv-row fv-plugins-icon-container">
                <select type="text" id="discountType" class="form-select @error('discount_type') is-invalid @enderror"
            ...
            <div class="row mb-8">
              ...
              <div class="col-xl-3 fv-row fv-plugins-icon-container">
                <input type="number" class="form-control form-control-solid @error('limit') is-invalid @enderror"
                  name="limit" value="{{ old('limit') }}" placeholder="Limit">
                <div class="fv-plugins-message-container invalid-feedback">
                  @error('limit')
                    {{ $message }}
                  @enderror
              ...
              <div class="col-xl-3 fv-row fv-plugins-icon-container">
                <select id="limitType" type="text" class="form-select @error('limit_type') is-invalid @enderror"
                  ...
                  data-minimum-results-for-search="Infinity">
                  <option value=""></option>
                  <option value="global" {{ old('limit_type') == 'global' ? 'selected' : '' }}>Global</option>
                  <option value="per_user" {{ old('limit_type') == 'per_user' ? 'selected' : '' }}>Per User</option>
                  <option value="on_order" {{ old('limit_type') == 'on_order' ? 'selected' : '' }}>On Order</option>
                </select>
                <div class="fv-plugins-message-container invalid-feedback">
                  @error('limit_type')
                    {{ $message }}
              ...
              <div class="col-xl-3 fv-row fv-plugins-icon-container">
                <input type="number"
                  ...
                  name="minimum_amount" value="{{ old('minimum_amount') }}" placeholder="Minimun amount to purchase">
                <div class="fv-plugins-message-container invalid-feedback">
                ...
                <!--begin::Hint-->
                <div class="form-text required">Ex: 100, 200, 300....</div>
                <!--end::Hint-->
              </div>
              <div class="col-xl-3">
              </div>
              <div id="maximunDiscountDiv" class="col-xl-3 fv-row fv-plugins-icon-container mt-5" style="display: none;">
                <input type="number"
                  class="form-control form-control-solid @error('maximum_amount') is-invalid @enderror"
                  name="maximum_amount" value="{{ old('maximum_amount') }}" placeholder="Maximum Discount">
                <div class="fv-plugins-message-container invalid-feedback">
                ...
                <!--begin::Hint-->
                <div class="form-text">Ex: 100, 200, 300....</div>
                <!--end::Hint-->
              </div>
              @php
                $users = \App\Models\User::role('customer')->get();
              @endphp
              <div id="specificUserDiv" class="col-xl-3 fv-row fv-plugins-icon-container mt-5" style="display: none;">
              ...
              <div class="col-xl-3 fv-row fv-plugins-icon-container mt-5">
                ...
                <!--begin::Hint-->
                <div class="form-text">Select Specific Category(Leave empty for all category)</div>
                <!--end::Hint-->
              </div>
              <div class="separator separator-dashed border-primary my-10"></div>
            </div>
              ...
              <div class="col-xl-3 fv-row fv-plugins-icon-container">
                <div class="position-relative d-flex align-items-center">
                  ...
                  <input class="form-control form-control-solid ps-12 kt_datepicker_with_time"
                    placeholder="Select a date" name="expire_date" type="date" readonly="readonly">
                  <!--end::Datepicker-->
                </div>
                <div class="fv-plugins-message-container invalid-feedback">
                  @error('expire_date')
                ...
                <select class="form-select @error('item_id') is-invalid @enderror" name="item_id[]"
                  ...
                  @foreach ($items as $item)
                    <option value="{{ $item->id }}"
                      {{ is_array(old('item_id')) && in_array($item->id, old('item_id')) ? 'selected' : '' }}>
            ...
            <div class="row">
              ...
              <div class="col-md-3 mb-10 mb-md-0">
                <div class="form-check form-switch form-check-custom form-check-solid align-items-start">
                  <label class="form-check-label fw-semibold text-gray-400 me-3 mt-2" for="status">Inactive</label>
                  <div class="text-center w-70px">
                    <input class="form-check-input" type="checkbox" value="1" name="approved" checked>
              ...
              <div class="col-md-3 mb-10 mb-md-0">
                <div class="form-check form-switch form-check-custom form-check-solid align-items-start">
                  <label class="form-check-label fw-semibold text-gray-400 me-3 mt-2" for="status">Inactive</label>
                  <div class="text-center w-70px">
                    <input class="form-check-input" type="checkbox" value="1" name="share_discount" checked>
