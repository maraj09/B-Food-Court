  ...
  <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
    ...
    <div class="d-flex align-items-center gap-2 gap-lg-3">
      ...
      <div class="d-flex align-items-center gap-2 gap-lg-3">
        ...
        <div class="m-0">
          ...
          <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true"
            ...
            <div class="px-7 py-5">
              ...
              <button class="btn btn-sm btn-info w-100 mt-3" id="kt_ecommerce_sales_flatpickr_clear_all">Clear Filters</button>
              <!--end::Select2-->
            </div>
            <!--end::Form-->
          </div>
        ...
        <a href="/dashboard/orders/create" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="tooltip"
          data-bs-placement="left" data-bs-dismiss="click" data-bs-trigger="hover"
          data-bs-original-title="Place an order" data-kt-initialized="1">
          <span id="kt_engage_demos_label">Create</span>
        </a>
        <!--end::Primary button-->
      </div>
      <!--end::Actions-->
