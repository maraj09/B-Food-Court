          ...
          <div class="d-block align-items-center border-dashed border-gray-900 bg-light rounded p-3 mb-7">
            ...
            <div class="d-flex flex-stack flex-wrap flex-grow-1">
              <div class="fw-bold fs-3 text-info">
                ...
                @else
                  <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle ps-0 border border-light-dark py-3 w-250px "
                    ...
                    <ul class="dropdown-menu w-250px" aria-labelledby="statusDropdown{{ $item->id }}">
