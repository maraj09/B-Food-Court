...
<div class="modal-body px-5 my-7">
  <!--begin::Form-->
  <form method="POST" class="form" action="/dashboard/user-management/users/{{ $user->id }}/update">
    @csrf
    <input type="hidden" name="is_edit" value="{{ $user->id }}">

    <!--begin::Scroll-->
    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_edit_user_scroll" data-kt-scroll="true"
      ...
      <div class="fv-row mb-7">
        ...
        <input type="email" name="email" class="form-control form-control-solid mb-3 mb-lg-0"
          placeholder="example@bfc.com" value="{{ old('email', $user->email) }}" />
        <!--end::Input-->
        @if ($errors->has('email'))
          ...
          <div class="d-flex fv-row">
            ...
            <div class="form-check form-check-custom form-check-solid">
              ...
              <input class="form-check-input me-3" name="user_role" type="radio" value="{{ $role->id }}"
                ...
                {{ old('user_role', $user->getRoleNames()->first()) == $role->name ? 'checked' : '' }} />
              <!--end::Input-->
              <!--begin::Label-->
