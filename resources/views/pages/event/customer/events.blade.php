            ...
            <div class="card-header bg-primary ribbon ribbon-start ribbon-clip">
              ...
              <div class="card-toolbar">
                <div class="d-flex flex-wrap flex-grow-1">
                  <div class="me-5">
                    <input class="form-control w-100px w-md-250px kt_datepicker_event_search_week_number" id="kt_datepicker_1" placeholder="Pick a date" />
                  </div>
                </div>
              </div>
            </div>
                          ...
                          <div class="form-group row">
                            <div class="col-lg-6">
                              ...
                              <div class="input-group w-md-150px" data-kt-dialer="true" data-kt-dialer-min="1"
                                ...
                                <!--begin::Input control-->
                                <input type="text" class="form-control" readonly placeholder="Seats" value="1"
                                  data-kt-dialer-control="input" id="event_book_seat_{{ $event->id }}" />
                                <!--end::Input control-->
