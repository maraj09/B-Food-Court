<div class="card card-flush h-md-100 d-flex flex-row-fluid">
  ...
  <div class="card-header draggable-handle border-0 py-0">
    ...
    <div class="card-toolbar">
      ...
      <div class="form-floating w-150px">
        <select class="form-select" data-control="select2" data-hide-search="true" id="durationSelectorDashboard"
  ...
  <div class="card-body p-0 mt-n5">
    <!--begin::Chart-->
    <div class="admin-dashboard-chart" data-kt-color="info" style="height: 225px"></div>
    <!--end::Chart-->
    <!--begin::Stats-->
    <div class="card-p mt-n5 position-relative">
      ...
      <div class="row g-0">
        <!--begin::Col-->
        <div
          class="col hover-elevate-up bg-light-warning px-4 py-8 rounded-2 mb-7 border border-warning border-dashed border-active active">
          <!--begin::Item-->
          <div class="d-flex flex-stack">
            ...
            <!--end::Section-->
            <!--begin::Label-->
            <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="{{ $totalUsers }}"
              data-kt-countup-prefix="+">0
            </div>
            <!--end::Label-->
          </div>
          <!--end::Item-->
          <a href="#" class="text-warning fw-semibold fs-6">Total Users</a>
        </div>
        <!--end::Col-->
        <!--begin::Col-->
        <div
          class="col hover-elevate-up bg-light-primary px-4 py-8 rounded-2 mb-7 ms-4 border border-primary border-dashed border-active active">
          <!--begin::Item-->
          <div class="d-flex flex-stack">
            <!--begin::Section-->
            <div class="d-flex align-items-center me-2">
            ...
            <!--end::Section-->
            <!--begin::Label-->
            <div class="" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top"
              title="Food">
              <div id="total-items-ordered" class="fs-4 fw-bold" data-kt-countup="true"
                data-kt-countup-value="{{ $totalItemsOrdered }}" data-kt-countup-prefix="+">0
              </div>
            </div>
            <!--end::Label-->
            <!--begin::Label-->
            <div class="mx-3 border-primary border-end-dashed border-start-dashed px-2" data-bs-toggle="tooltip"
              data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title="Play Area">
              <div id="total-play-areas-booked" class="fs-4 fw-bold" data-kt-countup="true"
                data-kt-countup-value="{{ $totalPlayAreasBooked }}" data-kt-countup-prefix="+">0
              </div>
            </div>
            <!--end::Label-->
            <!--begin::Label-->
            <div class="" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse" data-bs-placement="top"
              title="Events">
              <div id="total-events-booked" class="fs-4 fw-bold" data-kt-countup="true"
                data-kt-countup-value="{{ $totalEventsBooked }}" data-kt-countup-prefix="+">0
              </div>
            </div>
            <!--end::Label-->
          </div>
        ...
        <!--end::Col-->
        <!--begin::Col-->
        @can('dashboard-pricing-information')
          <div
            class="col hover-elevate-up bg-light-success px-4 py-8 rounded-2 ms-4 mb-7 border border-success border-dashed border-active active">
            <!--begin::Item-->
            <div class="d-flex flex-stack">
              <!--begin::Section-->
              <div class="d-flex align-items-center me-2">
                ...
                <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
                  <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 512 512" viewBox="0 0 512 512">
                    ...
                    <path fill="currentColor" opacity="0.3" d="M32,374.1h448V137.9H32V374.1z M428.6,148.3h30.6c5.5,0,10,4.5,10,10v30.6c0,5.5-4.5,10-10,10s-10-4.5-10-10
                    ...
                    <path fill="currentColor" d="M500,127.9c0-2.1-0.6-4-1.7-5.6c-1.6-2.3-4-3.9-6.9-4.3c-0.1,0-0.2,0-0.4-0.1c-0.3,0-0.7-0.1-1-0.1H22
                    ...
                    <path fill="currentColor" d="M240.7,263.1c-2.8,0-5.6-0.4-8.3-1.3c-3.2-1-6.6,0.2-8.5,2.9c-1.9,2.8-1.7,6.4,0.4,9l45.1,54.2l11.5-9.6
              ...
              <!--end::Section-->
              <!--begin::Label-->
              <div class="" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse"
                data-bs-placement="top" title="Food">
                <div id="total-earnings-for-items" class="fs-4 fw-bold" data-kt-countup="true"
                  data-kt-countup-value="{{ $totalEarningsForItems }}" data-kt-countup-prefix="+">0</div>
              </div>
              <!--end::Label-->
              <!--begin::Label-->
              <div class="mx-3 border-success border-end-dashed border-start-dashed px-2" data-bs-toggle="tooltip"
                data-bs-custom-class="tooltip-inverse" data-bs-placement="top" title="Play Area">
                <div id="total-earnings-for-play-areas" class="fs-4 fw-bold" data-kt-countup="true"
                  data-kt-countup-value="{{ $totalEarningsForPlayAreas }}" data-kt-countup-prefix="+">
                  0</div>
              </div>
              <!--end::Label-->
              <!--begin::Label-->
              <div class="" data-bs-toggle="tooltip" data-bs-custom-class="tooltip-inverse"
                ...
                <div id="total-earnings-for-events" class="fs-4 fw-bold" data-kt-countup="true"
                  data-kt-countup-value="{{ $totalEarningsForEvents }}" data-kt-countup-prefix="+">
                  0</div>
              </div>
              <!--end::Label-->
            </div>
      ...
      <div class="row gx-0">
        <!--begin::Col-->
        <div
          class="col hover-elevate-up bg-light-danger px-4 py-8 rounded-2 mb-7 border border-danger border-dashed border-active active "
        ...
        <!--begin::Col-->
        <div
          class="col hover-elevate-up bg-light-info px-4 py-8 rounded-2 mb-7 border border-info border-dashed border-active active">
          <!--begin::Item-->
          <div class="d-flex flex-stack">
            <!--begin::Section-->
            <div class="d-flex align-items-center me-2">
            ...
            <!--end::Section-->
            <!--begin::Label-->
            <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="{{ $totalVendors }}"
              data-kt-countup-prefix="+">
              0</div>
            <!--end::Label-->
          </div>
          <!--end::Item-->
          <a href="#" class="text-info fw-semibold fs-6">Total Vendors</a>
        </div>
        <!--end::Col-->
        <!--begin::Col-->
        @can('dashboard-pricing-information')
          <div
            class="col hover-elevate-up bg-light-info opacity-75 px-4 py-8 rounded-2 ms-4 mb-7 border border-info border-dashed border-active active">
            <!--begin::Item-->
            <div class="d-flex flex-stack">
              <!--begin::Section-->
              <div class="d-flex align-items-center me-2">
                <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
                <span class="svg-icon svg-icon-3x svg-icon-info opacity-75 d-block my-2">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                    height="24px" viewBox="0 0 24 24" version="1.1">
                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                      <rect x="0" y="0" width="24" height="24" />
              ...
              <!--end::Section-->
              <!--begin::Label-->
              <div id="vendor-earnings" class="fs-2 fw-bold" data-kt-countup="true"
                data-kt-countup-value="{{ $vendorEarnings }}" data-kt-countup-prefix="₹">
                0
              </div>
              <!--end::Label-->
            </div>
            <!--end::Item-->
            <a href="#" class="text-info fw-semibold fs-6">Vendor Earnings</a>
          </div>
        @endcan
        <!--end::Col-->
        <!--begin::Col-->
        <div
          class="col hover-elevate-up bg-light-secondary px-4 py-8 rounded-2 mb-7 border border-gray-700 border-dashed border-active active ms-4">
          <!--begin::Item-->
          <div class="d-flex flex-stack">
            <!--begin::Section-->
            <div class="d-flex align-items-center me-2">
            ...
            <!--end::Section-->
            <!--begin::Label-->
            <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="{{ $totalRatings }}"
              data-kt-countup-prefix="+">
              0</div>
            <!--end::Label-->
          </div>
