  ...
  <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
    ...
    <div class="d-flex align-items-center gap-2 gap-lg-3">
        ...
        <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_65a12143712c8">
          ...
          <div class="px-7 py-5">
            ...
            <div class="w-100 w-100 my-2">
              <select class="form-select" data-control="select2" data-placeholder="Customer"
                data-kt-ecommerce-order-filter="customer">
                <option></option>
                <option value="all">All</option>
                @foreach (\App\Models\User::role('customer')->get() as $user)
            ...
            <div class="w-100 w-100 my-2">
              <select class="form-select" data-control="select2" data-hide-search="true" data-placeholder="Action"
      ...
      <a href="#" class="btn btn-sm fw-bold btn-primary" data-bs-toggle="modal"
        data-bs-target="#kt_modal_stacked_1">Create</a>
      <!--end::Primary button-->
    </div>
    <!--end::Actions-->
  </div>
