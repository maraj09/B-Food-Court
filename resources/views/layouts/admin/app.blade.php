...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
  ...
  data-kt-app-toolbar-fixed-mobile="true" class="app-default">
  ...
  <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
    ...
    <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
      ...
      <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
        ...
        <!--end:::Main-->
        @yield('modules')
        @include('layouts.admin.modules.drawers.createOrderDrawer')
        @include('layouts.admin.modules.modals.addCustomer')
      </div>
    </div>
  </div>
  ...
  <script>
    var utilsScript = "{{ asset('custom/assets/js/intlTelInput/utils.js') }}"
  </script>
  ...
  <script src="{{ asset('custom/assets/js/admin.js') }}"></script>
  <script>
