                                          ...
                                          <tr>
                                            <td class="pb-50" style="padding-bottom: 50px;">
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                  <td class="fluid-img img-center pb-20"
                                                    style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 20px;">
                                                    <img
                                                      src="http://bhopalfoodcourt.com/wp-content/uploads/2024/04/Coupon.png"
                                                ...
                                                <tr>
                                                  <td class="text-16 lh-26 a-center pb-25"
                                                    ...
                                                    We hope you're doing well!. Use code at checkout to save
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                      ...
                                                      <tr>
                                                        <td class="title-22 a-center py-20 px-50 mpx-15"
                                                          ...
                                                          bgcolor="#f4ecfa">
                                                          <strong>USE CODE : <span class="c-purple"
                                                              style="color:#FF045D;">{{ $coupon->code }}</span></strong>
                                                        </td>
                                                      </tr>
                                                    </table>
                                                  </td>
