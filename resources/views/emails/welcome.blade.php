                                              ...
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td class="fluid-img img-center pb-25"
                                                    ...
                                                    <img
                                                      src="http://bhopalfoodcourt.com/wp-content/uploads/2024/04/Welcome.png"
                                                ...
                                                <tr>
                                                  <td class="text-16 lh-26 a-center pb-25"
                                                    ...
                                                    Welcome aboard! We're thrilled to have you join the </br><b>Bhopal
                                                      Food Court</b> community.
                                                  </td>
                                                </tr>
                                                @if ($points->signup_points['points'] > 0 && $user->hasRole('customer'))
                                                  <tr>
                                                    <td class="text-16 lh-26 a-center pb-25"
                                                      style="font-size:16px; color:#000000; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:center; padding-bottom: 25px;">
                                                      Welcome Points:<b><span style="color:#FF045D;">
                                                          {{ $points->signup_points['points'] }}
                                                        </span></b>
                                                    </td>
                                                  </tr>
                                                @endif
                                                ...
                                                <tr>
                                                  <td class="text-16 lh-26"
                                                    style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:left; padding-top: 25px;">
                                                    Get ready to explore a world of delicious flavors – from our
                                                    vendors! and play games.
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td class="text-16 lh-26"
                                                    ...
                                                    Stay tuned for exclusive offers and updates. Happy eating!
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td class="text-16 lh-26"
