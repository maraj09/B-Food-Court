                                        ...
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td class="pb-50" style="padding-bottom: 50px;">
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td class="a-center pb-25"
                                                    style="font-size:26px; color:#000000; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 16px; font-weight:bold; text-align:center; padding-bottom: 25px;">
                                                    <span style="color:#000000;"> Hi {{ $user->name }}</span>
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td class="fluid-img img-center pb-25"
                                                    style="font-size:0pt; line-height:0pt; text-align:center; padding-bottom: 25px;">
                                                    <img
                                                      src="http://bhopalfoodcourt.com/wp-content/uploads/2024/04/Points.png"
                                                ...
                                                <tr>
                                                  <td class="title-36 a-center pb-15"
                                                    ...
                                                    <strong>{{ $points }} Points Credited</strong>
                                                  </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                  <td class="text-16 lh-26"
                                                    style="font-size:16px; color:#6e6e6e; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 26px; text-align:left; padding-top: 5px;">
                                                    Best,
                                                  </td>
                                                </tr>
                                                <tr>
                              ...
                              <tr>
                                <td class="text-14 lh-24 a-center c-white l-white pb-20"
                                  ...
                                  <a href="{{ $settings->company_address_map_link }}" target="_blank"
                                    class="link c-white" style="text-decoration:none; color:#ffffff;">{{ $settings->company_address }}</a>
                                  <br />
