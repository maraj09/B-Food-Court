                                              ...
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td class="fluid-img img-center pb-50"
                                                    ...
                                                    <img
                                                      src="http://bhopalfoodcourt.com/wp-content/uploads/2024/04/Order-Placed.png"
                                                ...
                                                <tr>
                                                  <td class="text-16 lh-26 a-center"
                                                    ...
                                                    We will send you the Push Notification for your order status.
                                                  </td>
                                                </tr>
                                              </table>
                                            </td>
                                              ...
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                            ...
                                                            <table width="100%" border="0" cellspacing="0"
                                                              ...
                                                              <tr>
                                                                <td class="text-16 lh-26 c-black"
                                                                  ...
                                                                  {{ $orderItem->item->vendor->brand_name }}
                                                                  <br />
                                                                  <strong>Stall No:</strong>
                                                                  {{ $orderItem->item->vendor->stall_no }}
                                                                  <br />
                                                            ...
                                                            <tr>
                                                              <td class="text-16"
                                                                ...
                                                                @if ($payment->method == 'card')
                                                                  {{ $payment->card->network }} ending in
                                                                  {{ $payment->card->last4 }}
                                                ...
                                                <tr>
                                                  <td class="text-16 lh-26 a-center pb-25"
                                                    ...
                                                    <em>To check your order status visit the below link</em>
                                                  </td>
                                                </tr>
                                                <tr>
                                                  <td align="center">
                                                      ...
                                                      <tr>
                                                        <td class="btn-16 c-white l-white" bgcolor="#f3189e"
                                                          ...
                                                          <a href="{{ url('/orders/' . $order->id) }}"
                                                            ...
                                                            style="display: block; padding: 15px 35px; text-decoration:none; color:#ffffff;">
                                                            <span class="link c-white"
                                                              style="text-decoration:none; color:#ffffff;">VIEW MY
                                                              ORDER</span>
                                                          </a>
                                                        </td>
                                                      </tr>
