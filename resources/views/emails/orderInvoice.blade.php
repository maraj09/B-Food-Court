...
<head>
 ...
 <![endif]-->
  ...
  <style type="text/css" media="screen">
    ...
    .gradient {
      background: linear-gradient(90deg, #FFC002 0%, #80E7CC 30%, #8856BB 40%, #FE3C5F 75%, #4A31A3 100%);
    }
                                  ...
                                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td class="img-center p-30 px-15"
                                        style="font-size:0pt; line-height:0pt; text-align:left; padding: 30px; padding-left: 15px; padding-right: 15px;">
                                        <a href="#" target="_blank"><img
                                            src="http://bhopalfoodcourt.com/wp-content/uploads/2024/02/Bhopal-Food-Court-DL.png"
                                            width="160" height="auto" border="0" alt="" /></a>
                                      </td>
                                      <td class="text-16 a-center pb-25"
                                        style="font-size:16px; color:#000000; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; line-height: 16px; text-align:right; padding-bottom: 25px;padding-left: 15px; padding-right: 15px;">
                                        <b><span style="color:#FF045D;"> {{ $user->point->points }} Points
                                          </span></b></br>
                                        <span style="color:#000000;"> Point Balance</span>
                                      </td>
                                    </tr>
                                  </table>
                                  <!-- Logo -->
                                              ...
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                  <td class="fluid-img img-center pb-50"
                                                    ...
                                                    <img
                                                      src="http://bhopalfoodcourt.com/wp-content/uploads/2024/04/Order-Delivered.png"
                                                      width="300" height="300" border="0" alt="" />
                                                  </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                  <td align="center">
                                                    ...
                                                    <table border="0" cellspacing="0" cellpadding="0"
                                                      ...
                                                      <tr>
                                                        <td class="btn-16 c-white l-white" bgcolor="#FF045D"
                                                          ...
                                                          <a href="{{ url('/orders/' . $order->id) }}" target="_blank"
                                                            ...
                                                            <span class="link c-white"
                                                              style="text-decoration:none; color:#ffffff;">MY
                                                              ACCOUNT</span>
                                                          </a>
                                                        </td>
                                                      </tr>
                                              ...
                                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                          ...
                                                          <table width="100%" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                              <td class="title-20 pb-15"
                                                                ...
                                                                <strong>Order <span class="c-purple"
                                                                    style="color:#FF045D;">#{{ $order->custom_id }}</span></strong>
                                                              </td>
                                                            </tr>
                                                          ...
                                                          <table width="100%" border="0" cellspacing="0"
                                                            ...
                                                            <tr>
                                                              <td class="text-16"
                                                                ...
                                                                {{ \Carbon\Carbon::parse($order->updated_at)->format('d-F-Y | g:iA') }}
                                                              </td>
                                                            </tr>
                                                          </table>
                                                        </th>
                                                  ...
                                                  <td class="py-15"
                                                    ...
                                                    <table width="100%" border="0" cellspacing="0"
                                                      ...
                                                      <tr>
                                                        ...
                                                        <td class="title-20 a-center mw-auto" width="60"
                                                          style="font-size:20px; line-height:24px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:left;">
                                                          <strong>Image</strong>
                                                        </td>
                                                        <td class="img" width="20"
                                                          style="font-size:0pt; line-height:0pt; text-align:left;">
                                                        </td>
                                                        <td class="title-20 mw-auto" width="200"
                                                        ...
                                                        <td class="title-20 a-center mw-auto" width="40"
                                                          style="font-size:20px; line-height:24px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:left;">
                                                          <strong>Price</strong>
                                                        </td>
                                                        <td class="img" width="20"
                                                ...
                                                @foreach ($order->orderItems()->whereNot('item_id', null)->get() as $orderItem)
                                                    ...
                                                    <tr>
                                                      <td class="py-25"
                                                        ...
                                                        <table width="100%" border="0" cellspacing="0"
                                                          cellpadding="0">
                                                          <tr>
                                                            <th class="column-top" valign="top" width="60"
                                                              style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                                              <table width="100%" border="0" cellspacing="0"
                                                                cellpadding="0">
                                                                <tr>
                                                                  <td class="title-20 mw-auto" width="60"
                                                                    style="font-size:20px; line-height:24px; color:#282828; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important;">
                                                                    <a href="{{ url('/orders/' . $order->id) }}"
                                                                      target="_blank"><img
                                                                        src="{{ asset($orderItem->item->item_image) }}"
                                                            ...
                                                            <th class="column-top" valign="top" width="200"
                                                              style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                                              <table width="100%" border="0" cellspacing="0"
                                                                cellpadding="0">
                                                                <tr>
                                                            ...
                                                            <th class="column-top mpb-15" valign="top"
                                                              width="20"
                                                              style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                                            </th>
                                                            <th class="column-top" valign="top" width="40"
                                                              style="font-size:0pt; line-height:0pt; padding:0; margin:0; font-weight:normal; vertical-align:top;">
                                                              <table width="100%" border="0" cellspacing="0"
                                                                cellpadding="0">
                                                                <tr>
                                                                  <td class="title-20 a-center mt-left"
                                                                    style="font-size:20px; line-height:24px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center;">
                                                                    <strong>{{ $orderItem->item->price }}</strong>
                                                                  </td>
                                                                </tr>
                                                              </table>
                                                            </th>
                                                            ...
                                                            <th class="column-top" valign="top" width="40"
                                                              ...
                                                              <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                  <td class="title-20 a-center mt-left"
                                                                    style="font-size:20px; line-height:24px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:center;">
                                                                    <strong>&times;{{ $orderItem->quantity }}</strong>
                                                                  </td>
                                                                </tr>
                                                              </table>
                                                            </th>
                                                              ...
                                                              <table width="100%" border="0" cellspacing="0"
                                                                ...
                                                                <tr>
                                                                  <td class="title-20 a-right mt-left"
                                                                    style="font-size:20px; line-height:24px; color:#282828; font-family:'PT Sans', Arial, sans-serif; min-width:auto !important; text-align:right;">
                                                                    <strong>₹{{ $orderItem->item->price * $orderItem->quantity }}</strong>
                                                                  </td>
                                                                </tr>
                                                              </table>
                                                            </th>
                                                  ...
                                                  @elseif ($orderItem->status == 'rejected')
                                                    @php
                                                      $rejectedItemsCost += $orderItem->price * $orderItem->quantity;
                                                    @endphp
                                                  @endif
                                                @endforeach
                                                <tr>
                                                                ...
                                                                <table border="0" cellspacing="0" cellpadding="0"
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <td class="title-20 lh-30 mt-right"
                                                                      ...
                                                                      @endphp
                                                                      ₹{{ $totalOrginalPrice - $totalDiscountedPrice }}
                                                                    </td>
                                                                  </tr>
                                                                  <tr>
                                                                  ...
                                                                  <tr>
                                                                    ...
                                                                    <td class="title-20 lh-30 mt-right"
                                                                      style="font-size:20px; color:#282828; font-family:'PT Sans', Arial, sans-serif; text-align:left; min-width:auto !important; line-height: 30px;">
                                                                      ₹{{ $order->gst_amount + $order->sgt_amount + $order->service_tax }}
                                                                    </td>
                                                                  </tr>
                                                                  <tr>
                                                                    ...
                                                                    <td class="title-20 lh-30 c-purple pt-10 mt-right"
                                                                      ...
                                                                      <strong>₹{{ $order->net_amount - $rejectedItemsCost }}</strong>
                                                                    </td>
                                                                  </tr>
                                                                </table>
                                                              </td>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  ...
                                  <table border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      <td class="img" width="34"
                                        style="font-size:0pt; line-height:0pt; text-align:left;">
                                        <a href="{{ $settings->facebook ?? url('/') }}" target="_blank"><img
                                      ...
                                      <td class="img" width="34"
                                        style="font-size:0pt; line-height:0pt; text-align:left;">
                                        <a href="{{ $settings->instagram ?? url('/') }}" target="_blank"><img
                              ...
                              <tr>
                                <td class="text-14 lh-24 a-center c-white l-white pb-20"
                                  ...
                                  <a href="{{ $settings->company_address_map_link }}" target="_blank"
                                    class="link c-white"
                                    style="text-decoration:none; color:#ffffff;">{{ $settings->company_address }}</a>
                                  <br />
                                  @if (json_decode($settings->company_contact_phone, true) != null)
                                    @foreach (json_decode($settings->company_contact_phone, true) as $phoneNumber)
                                      <a href="tel:{{ $phoneNumber['value'] }}" target="_blank" class="link c-white"
                                        style="text-decoration:none; color:#ffffff;">
                                        <span class="link c-white"
                                          style="text-decoration:none; color:#ffffff;">{{ $phoneNumber['value'] }}</span>
                                      </a>
                                      @if (!$loop->last)
                                        -
                                      @endif
                                    ...
                                    <br />
                                  @endif
                                  @if ($settings->company_contact_email)
                                    <a href="mailto:{{ $settings->company_contact_email }}" target="_blank"
                                      class="link c-white" style="text-decoration:none; color:#ffffff;"><span
                                        class="link c-white"
                                        style="text-decoration:none; color:#ffffff;">{{ $settings->company_contact_email }}</span></a>-
                                  @endif
                                  <a href="{{ url('/') }}" target="_blank" class="link c-white"
                                    style="text-decoration:none; color:#ffffff;"><span class="link c-white"
                                      style="text-decoration:none; color:#ffffff;">{{ url('/') }}</span></a>
                                </td>
                              </tr>
                            </table>
                          </td>
